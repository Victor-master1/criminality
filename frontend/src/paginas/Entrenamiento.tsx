...
export default function Entrenamiento() {
  ...
  return (
    <div className="space-y-8 animate-slide-up">
      <div>
        <h1 className="text-4xl md:text-5xl font-bold text-slate-900 mb-2">Configurar Entrenamiento</h1>
        <p className="text-slate-600 text-lg">Define los parámetros de tu modelo</p>
      </div>
          ...
          {columnas.length > 0 && (
            <div className="card p-6">
              <div className="flex items-center space-x-3 mb-6">
                ...
                <h2 className="text-2xl font-bold text-slate-900">Columnas de Entrada</h2>
              </div>
          ...
          {columnas.length > 0 && (
            <div className="card p-6">
              <div className="flex items-center space-x-3 mb-6">
                ...
                <h2 className="text-2xl font-bold text-slate-900">Variable Objetivo</h2>
              </div>
              <select
                ...
                className="input-field"
              >
                <option value="">Seleccionar columna objetivo</option>
                {columnas.map((col) => (
        ...
        <div className="space-y-6">
          <div className="card p-6">
            ...
            <div className="space-y-3">
              {['clasificacion', 'regresion', 'red_neuronal'].map((tipo) => (
                <label key={tipo} className="flex items-center space-x-3 cursor-pointer p-4 border-2 border-slate-200 rounded-xl hover:bg-slate-50 hover:border-primary-300 transition-colors group">
                  ...
                  />
                  <span className="font-semibold text-slate-700 capitalize group-hover:text-primary-600 transition-colors">
                    {tipo.replace('_', ' ')}
                  </span>
                </label>
              ))}
          ...
          <div className="card p-6">
            ...
            <div className="space-y-5">
              ...
              <div>
                <label className="block text-sm font-semibold text-slate-700 mb-3">Épocas</label>
                <input
                  type="number"
                  value={config.epocas}
