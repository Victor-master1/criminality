              ...
              <ResponsiveContainer width="100%" height={300}>
                <LineChart data={prepararDatosROC()}>
                  ...
                  <XAxis 
                    dataKey="fpr" 
                    stroke="#64748b" 
                    label={{ value: 'Tasa Falsos Positivos', position: 'insideBottom', offset: -5 }}
                    domain={[0, 1]}
                  />
                  <YAxis 
                    stroke="#64748b" 
            ...
            <div className="card p-6">
              ...
              <ResponsiveContainer width="100%" height={300}>
                <ScatterChart>
                  ...
                  <Line type="monotone" dataKey="prediccion" data={prepararDatosPrediccionesVsReales().filter(d => d.real === d.prediccion)} stroke="#ef4444" strokeWidth={2} strokeDasharray="5 5" dot={false} name="Ideal" />
                </ScatterChart>
              </ResponsiveContainer>
            </div>
          )}
